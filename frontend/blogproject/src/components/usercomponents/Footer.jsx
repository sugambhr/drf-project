        ...
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
              <Link to="http://localhost:5173/" className="flex items-center">
                  <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRc4XOdTwDFjrNDoRbCH2vDqCNCKD9u8zVr_g&s" className="h-10 me-3 rounded-full" alt="Logo" />
                  <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Vlog</span>
              </Link>
          </div>
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  ...
                  <ul className="text-gray-500 dark:text-gray-400 font-medium">
                      <li className="mb-4">
                          <Link to="http://localhost:5173/" className="hover:underline">Blog</Link>
                      </li>
                      <li>
                          <Link to="http://localhost:5173/register" className="hover:underline">Register</Link>
                      </li>
                  </ul>
              </div>
              <div>
