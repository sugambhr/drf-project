...
const Homepage = () => {
  ...
  return (
    ...
    <div className="font-[sans-serif] py-4 mx-auto lg:max-w-7xl sm:max-w-full">
      <h2 className="text-4xl font-extrabold text-gray-800 mb-12">Premium Database</h2>
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {blog.map((b,i)=>(
            // <Card data={b} key={i}/>
            <>
             <div
          className="bg-gray-50 shadow-md overflow-hidden rounded-lg cursor-pointer hover:-translate-y-2 transition-all relative" key={i}>
          <div
          ...
          <div className="p-6 bg-white">
            ...
            <h4 className="text-lg text-gray-800 font-bold mt-2">{b.category}</h4>
            <h4 className="text-lg text-gray-800 font-bold mt-2">{b.author}</h4>
